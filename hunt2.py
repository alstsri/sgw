...
SEARCH_GROUPS: dict[str, dict[str, Any]] = {
    ...
    "shirts": {
        ...
        "strings": [
            ...
            "Figaret shirt 15", "Courtot shirt 15",
            ...
            # Exceptional-maker 15.5 items are already returned by the "... 15"
            # searches above (a "15" query matches "15.5" titles) and assess()
            # keeps 15.5 only for these makers — so no separate 15.5 search is
            # needed. Barba only had a "Barba Napoli" entry, so add a plain one.
            "Barba shirt 15",
            # Fabric
    ...
    "blankets": {
        ...
        "category_level": 1,
        "strings": [
            "cashmere throw", "cashmere blanket",
            "merino wool throw", "merino blanket",
            "alpaca throw", "alpaca blanket",
            "mohair throw", "mohair blanket",
            "Begg & Co cashmere", "Johnstons of Elgin cashmere",
        ],
    },
}
